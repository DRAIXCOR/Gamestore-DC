...
<head>
    ...
    <title>Información de la Plataforma</title>
    <style>
        html, body {
            height: 100%;
            margin: 0;
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <!-- Cambiar la clase 'navbar-light' a 'navbar-dark' y 'bg-light' a 'bg-dark' -->
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('plataforma.edit', $plataforma) }}" class="btn btn-primary">Editar</a>
            <a href="{{ route('plataforma.index', $plataforma) }}" class="btn btn-secondary">Volver</a>
